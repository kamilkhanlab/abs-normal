...
function calculate_ODE(
    ...
    for i in initialize:occurences
        if account_for_time == true
            ...
            BETA_total = BETA_base + BETA_time * timeI[i]     #TODO: This line isnt doing much ?
...
Z_coeff1, L_coeff1, J_coeff1, Y_coeff1, BETA_base1, BETA_time1 = generate_RELU_ODE(n, numLayers, THETA, CCOEFF)
...
xk_output = calculate_ODE(
    ...
    Z_coeff2, L_coeff2, J_coeff2, Y_coeff2, BETA_base2, BETA_time2;
